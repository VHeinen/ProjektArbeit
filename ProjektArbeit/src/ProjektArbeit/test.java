...
//		database.writeGradeInDatabase(2, 3, 1.3f, "Test", Date.valueOf("2023-05-25"), 0, 0, 0);
//		database.writePupilManagementInDatabase(1, "test", "null", 1);
//		database.writeTeacherManagementInDatabase(1, "schach", "matt", 1);
//	
...
//		
//		database.writeGradeInDatabase(8, 1, 1.0f, "Test", Date.valueOf("2023-05-08"), 3, 6, 3);
//		database.writeGradeInDatabase(9, 1, 1.0f, "Klassenarbeit", Date.valueOf("2023-05-25"), 3, 6, 1);
//		database.writeGradeInDatabase(10, 3, 1.0f, "Präsi", Date.valueOf("2023-02-24"), 3, 2, 6);
//		database.writeGradeInDatabase(11, 4, 1.0f, "Test", Date.valueOf("2023-03-12"), 3, 8, 8);
//		database.writeGradeInDatabase(12, 2, 1.0f, "Aufgaben Abgabe", Date.valueOf("2023-01-04"), 3, 10, 4);
//		
//		
...
//		
//		String tableName = "teachermanagement";
//		String columnName = "passwort";
//		int id = 1;
//		String change = "matt";
//		
...
//		document = pdf.createTableForPDFByQuery(document, query, 2);
//		
//		document = pdf.createWhitespaceForNewTables(document);
//		
//		
